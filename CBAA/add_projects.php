...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO cbaa_projects (title, description, status, back, backname, picture, picturename) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    if (mysqli_stmt_execute($statement)) {
        ...
        header("Location: cbaamodify.php"); // Redirect to the CBAA page or any other desired page
        exit;
    } else {

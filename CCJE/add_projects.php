...
session_start();
if (!isset($_SESSION["loggedin"]) || $_SESSION["department"] !== "CCJE") {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO ccje_projects (title, description, status, back, backname, picture, picturename) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    if (mysqli_stmt_execute($statement)) {
        ...
        header("Location: ccjemodify.php"); // Redirect to the CBAA page or any other desired page
        exit;
    } else {

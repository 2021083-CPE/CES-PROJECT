...
<head>
    ...
    <title>view | CEAS Projects</title>
...
<section id="header">
    ...
    <section id="CBAAprojects">
        <div class="CBAAcontainer">
            ...
            $query = "SELECT * FROM ceas_projects";
            ...
            if ($result) {
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='../CEAS/uploads/" . $row['backname'] . "' target='_blank'>View</a>";
    ...
    <!-- Join form -->
    <form id="join-form" action="../CEAS/volunteers.php" method="POST">
